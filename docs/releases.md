...
The existing npm/GitHub release is 3.1.0. Source version 3.2.0 was never published. The current cleanup is a breaking change and is prepared as 4.0.0-rc.1. Keep it on the `next` channel until the documented live basket limitation is resolved.
